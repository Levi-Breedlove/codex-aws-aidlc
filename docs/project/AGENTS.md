...
- Use balanced, labeled `<details>` only for appendices or exact records. Never collapse the current action, material risk, command, project diagram, readiness summary, approval or authorization boundary, or formal receipt.
